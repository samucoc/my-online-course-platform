...
import CursoForm from './CursosForm'; // Asegúrate de que el componente CursoForm exista
...
const Cursos = () => {
  ...
  useEffect(() => {
    const fetchCursos = async () => {
      try {
        const cursosResponse = await axios.get(`${API_BASE_URL}/cursos`);
        ...
        const combinedData = cursosData.map(curso => {
